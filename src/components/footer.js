              ...
              <div class="row">
                <div class="col-md-5 col-sm-12 mb-4">
                  ...
                  <div className="my-4 text-desc-footer justify-content text-justify">
                    ...
                    standard dummy text ever since is simply dummy text of the
                    printing Lorem Ipsum has been the industry's standard dummy
                    text ever since
                  </div>
                  <div>
                    <h5>Follow Us On:</h5>
                ...
                <div class="col col-md-2 offset-md-2 offset-1">
                  ...
                  <ul class="nav flex-column">
                    <li class="nav-item my-2">
                      <a href="#hero" class="nav-link p-0 text-muted">
                        Home
                      </a>
                    </li>
                    <li class="nav-item my-2">
