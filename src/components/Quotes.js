    ...
    return (
      <>
        ...
        <div class="bg-dark-cs">
          <div class="quotes px-4 py-5 mt-0 text-center">
            <div class="py-5 mt-5">
              ...
              >
                <div class="carousel-inner">
                  <div class="carousel-item active" data-bs-interval="2700">
                    <p class="text-white">“teks 1”</p>
                    <p class="text-desc-footer">- Lorem Ipsum -</p>
                  </div>
                  <div class="carousel-item" data-bs-interval="2700">
                    <p class="text-white">“teks2”</p>
                    <p class="text-desc-footer">- Lorem Ipsum -</p>
                  </div>
                  <div class="carousel-item" data-bs-interval="2700">
                    <p class="text-white">“teks3”</p>
                    <p class="text-desc-footer">- Lorem Ipsum -</p>
                  </div>
                </div>
                {/* <button
